...
<body class="">
    ...
    <input type="text" id="column1" name="column1" value="<?php echo isset($row['column1']) ? htmlspecialchars($row['column1']) : ''; ?>"><br><br>

    <label for="column2">Column 2:</label>
    <input type="text" id="column2" name="column2" value="<?php echo isset($row['column2']) ? htmlspecialchars($row['column2']) : ''; ?>"><br><br>
