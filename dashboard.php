                ...
                <div class="container-fluid">
                                ...
                                <div class="col-lg-6 col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <h6 class="text-uppercase font-size-12 text-muted mb-3">Client ID: <?php echo $row["client_id"]; ?></h6>
                                                    <span class="h3 mb-0">Client Name: <?php echo $row["client_name"]; ?></span>
                                                </div>
                                                <div class="col-auto">
                                                    <span class="badge badge-soft-success"> <a href="view_performance.php?client_id=<?php echo $row['client_id']; ?>">View</a></span>
                                                </div>
                                            </div> <!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">List of Managers</p>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Client - Manager</h4>
                                    <p class="card-subtitle mb-4">List of Managers</p>
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped table-nowrap">
                                            <thead>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4">updated</p>
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped table-nowrap">
                                            <thead>
                                                <tr>
