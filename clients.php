        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="admin_dashboard.php" class=""><i class="ti-home"></i>
                            Dashboard </a></li>
        ...
        <div class="main">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td><a href="add_fields.php?client_id=' . $row['client_id'] . '" class="btn btn-primary">Edit Fields</a>
                    <a href="view_performance.php?client_id=' . $row['client_id'] . '" class="btn btn-primary">View Performance</a></td>';
                    echo "</tr>";
                }
            } else {
